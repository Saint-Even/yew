...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(csv
     ...
     (conda
      :variables conda-anaconda-home "~/miniconda3")
     yaml
     git
     (shell :variables
